...
public class A02_Calcu02 {
	...
	public static void main(String[] args) {
		...
		/*
		3. 문자열의 + 연산자
			+는 숫자형 데이터의 경우 합산을 처리하지만, 문자열의 데이터인 경우 문자열고 문자열을 이어주는 역할
		...
		// 투수의 자책점 4점, 경기회수(이닝) 5, 방어율이 얼만지를 프로그램상으로 출력하세요.
		// 선언할 변수 - 자책점, 이닝, 방어율
		int loss = 4;
		int game = 5;
		double B = (loss*9)/(double)game;
		System.out.println("경기한 회수(이닝수) : "+game);
		System.out.println("실점 : "+loss);
		System.out.println("방어율 : "+B);
