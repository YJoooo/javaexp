...
public class A01_Scanner {
	...
	public static void main(String[] args) {
		...
		// 2. 사용 방법
		//	1) 내장되었지만, 기본 java.lang 패키지가 아니어서 import를 상단에 해주어서 객체를 생성해서 사용할 수 있다.
		Scanner sc = new Scanner(System.in);
		//	2) 객체를 생성할 떄, 생성자의 매개변수를 java의 기본 io의 입력 처리 객체인 System.in으로 할당하여야 한다.
		//	3) 객체가 생성되면 기본적으로 nextLine()메서드를 통해서 console에서 line단위로 문자열을 데이터 입력받을 수 있다.
		System.out.println("이름을 입력하세요!!");
		String name = sc.nextLine(); //enter키를 입력할 때까지 문자열 데이터를 입력 받는다.
