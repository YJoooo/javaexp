...
public class A01_Basic {
	...
	public static void main(String[] args) {
		...
		System.out.println("flow의 진행:"+cnt++);
		if(cnt==6)// 하단에 한라인만 조건으로 처리 프로세스를 나눌 때.
		...
		int fruCnt =2;
		System.out.println(fruCnt+=2);
		if(fruCnt==4) {
			System.out.println("#fruCnt가 2일때 처리할 flow #");
			System.out.println("flow의 진행:"+(fruCnt+=2));
			System.out.println("# 종료 #");
		}
		System.out.println(fruCnt+=2);
		System.out.println(fruCnt+=2);
		if(fruCnt==10) System.out.println("flow의 진행(옆에 조건):"+(fruCnt+=2));
		System.out.println(fruCnt+=2);
		if(fruCnt==14)
			System.out.println("flow의 진행(중괄호 블럭 없이):"+(fruCnt+=2));
		System.out.println(fruCnt+=2);
		System.out.println(fruCnt+=2);
		...
		System.out.println("과일의 갯수:"+(fruCnt1+=2));
		if(fruCnt == 10) System.out.println("과일의 갯수(바로 옆):"+(fruCnt1+=2));
		System.out.println("과일의 갯수:"+(fruCnt1+=2));
		if(fruCnt == 14)
