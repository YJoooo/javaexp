...
//				default 생성자를 개발자에 의해서 생성자를 선언하는 순간 사라진다. 
		Music m02 = new Music("행복한음악");
		// ex) Player 객체를 선언하고 default 생성하고 출력한후, 문자열을 받아서 이름을 출력하는 생성자를 선언하고 출력하세요.
		Player play01 = new Player("김연주"); // default 생성자를 호출.
...
class Player{
	Player(String name){
		System.out.println("플레이어의 이름은 "+name);
	}
